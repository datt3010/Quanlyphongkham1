...
('TH000','Null',N'Null',0,N'Null','2023-10-12',12),
('TH001',N'ACEMUC 100 mg gói',N'Gói',10000,N'Ngày 1 gói','2023-10-12',12),
('TH002',N'ACEMUC gói 200 mg(2)',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',12),
('TH003',N'ACEMUC viên 200 mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',12),
('TH004',N'AcetylCystein Boston 100mg',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',12),
('TH005',N'Acid Ascorbic 500 mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',13),
('TH006',N'Alphachoay (HGiang)',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',13),
('TH007',N'ALUMAG-S',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',13),
('TH008',N'Amitriptiline 25mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',13),
('TH009',N'Amlodipin 5mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',14),
('TH010',N'AMOXICILIN  250MG',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',14),
('TH011',N'Amoxicilin 500mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',14),
('TH012',N'ANGELA GOLD LỌ/6OV',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',14),
('TH013',N'ALIPAS',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',15),
('TH014',N'Allerfor 4mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',15),
('TH015',N'ZINNAT 500 mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',15),
('TH016',N'Zengesic',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',15),
('TH017',N'Zinmax 250mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',15),
('TH018',N'PANAGIN',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',16),
('TH019',N'PANTOPRAZOL 40 mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',16),
('TH020',N'PESANCORT 15g',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',16),
('TH021',N'ACTAPULGITE gói',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',16),
('TH022',N'ALBENDAZOL 0.2',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',17),
('TH023',N'ACYCLOVIR 800',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',17),
('TH024',N'Allupurinol 300mg',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',17),
('TH025',N'ZITROMAX 200ml',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',17),
('TH026',N'PANTHENOL ',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',18),
('TH027',N'Partamol 325mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',18),
('TH028',N'PESANCORT 15g',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',18),
('TH029',N'Zedcal 200ml',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',18),
('TH030',N'TANGANIL 500mg(pháp)',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',19),
('TH031',N'Apesone 50mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',19),
('TH032',N'Apesone 50mg',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',20),
('TH033',N'Apesone 50mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',20),
('TH034',N'Apesone 50mg',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',20),
('TH035',N'Apesone 50mg',N'Gói',20000,N'Ngày 1v x 2 lần','2023-10-12',21),
('TH036',N'Apesone 50mg',N'Viên',20000,N'Ngày 1v x 2 lần','2023-10-12',21);
GO
