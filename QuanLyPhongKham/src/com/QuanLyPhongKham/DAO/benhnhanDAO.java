...
public class benhnhanDAO extends QLPhongKham_DAO<BenhNhan, Integer>{
    String Insert_BenhNhan = "INSERT INTO benhnhan (tenbenhnhan,sodienthoai,gioitinh,ngaysinh,diachi,manhanvien) VALUES(?,?,?,?,?,?)";
    String Update_BenhNhan = "UPDATE benhnhan SET tenbenhnhan=? , sodienthoai=? , gioitinh=? , ngaysinh=? , diachi=?, manhanvien=? WHERE mabenhnhan = ?";
    ...
    public void insert(BenhNhan entity) {
        try {
            jdbcHelper.update(Insert_BenhNhan, entity.getTenbenhnhan(),entity.getSodienthoai(),entity.getGioitinh(),entity.getNgaysinh(),entity.getDiachi(),entity.getManhanvien());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void update(BenhNhan entity) {
        ...
        try {
            jdbcHelper.update(Update_BenhNhan, entity.getTenbenhnhan(),entity.getSodienthoai(),entity.getGioitinh(),entity.getNgaysinh(),entity.getDiachi(),entity.getManhanvien(),entity.getMabenhnhan());
        } catch (Exception e) {
            e.printStackTrace();
        }
